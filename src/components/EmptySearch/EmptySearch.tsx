...
const EmptySearch: React.FC<EmptySearchProps> = ({ keyword }) => {
    return (
        <section className="empty-search-container" aria-label="Không tìm thấy kết quả">
            <div className="empty-search-card">
                ...
                <div className="empty-search-content">
                    ...
                    <div className="empty-suggestions">
                        <div className="suggestion-item">
                            <span className="dot-icon" aria-hidden="true"></span>
                            <span className="text">
                ...
                {/* Cột phải: Hình ảnh tối ưu đa phân giải */}
                <div className="empty-search-image">
                     <img
                        alt="Không tìm thấy kết quả tìm kiếm"
                        loading="lazy"
