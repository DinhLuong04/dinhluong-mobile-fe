...
// SỬA Ở ĐÂY: Thêm " = [] " vào sau compareList để tạo giá trị mặc định
const StickyCompareBar: React.FC<StickyCompareBarProps> = ({ 
    ...
    // Thêm lớp bảo vệ (Safety Guard): Nếu vẫn null thì không render gì cả
            ...
            <div className='container'>
                ...
                <div className="compare-inner">
                    <div className="product-list">
                        {/* Thêm dấu ? trước .map (Optional Chaining) để an toàn hơn nữa */}
