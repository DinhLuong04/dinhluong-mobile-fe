...
import { useStickyProductBar } from './useStickyProductBar';
            ...
            <div className="container spb-container">
                ...
                <div className="spb-left">
                    ...
                    <div className="spb-info">
                        <div className="spb-title-row">
                            <h3 className="spb-name">{name || "Đang tải..."} {rom}</h3>
                ...
                <div className="spb-right">
                    ...
                    <div className="spb-actions">
                        <button 
                            className={`spb-btn-cart icon-btn ${stock <= 0 ? 'disabled' : ''}`} 
                        ...
                        <button 
                            className={`spb-btn-buy ${stock <= 0 ? 'disabled' : ''}`} 
                            disabled={stock <= 0}
                            onClick={handleBuyNow}
                        >
                            {stock > 0 ? "Mua ngay" : "Tạm hết hàng"}
                        </button>
